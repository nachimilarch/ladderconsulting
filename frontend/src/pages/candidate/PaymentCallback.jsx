            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                ...
                {status === 'success' && (
                    <>
                        ...
                        <p className="text-sm text-gray-600 mb-6">Your Premium profile is now active.</p>
                        <button
                            onClick={() => navigate('/candidate/premium')}
                ...
                {status === 'pending' && (
                    <>
                        ...
                        <p className="text-sm text-gray-600 mb-6">Payment is being processed. This page will update shortly. If it doesn't within 5 minutes, contact support.</p>
                        <button
                            onClick={() => navigate('/candidate/premium')}
                            className="bg-indigo-600 text-white py-2.5 rounded-xl text-sm font-medium hover:bg-indigo-700 transition w-full"
                        >
