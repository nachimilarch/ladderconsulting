...
const processSuccessfulPayment = async (txn, paymentId, conn) => {
    ...
    // Activates whatever this invoice paid for (job, Premium status, AI
    // subscription, placement-fee mirror, …) — shared with manual Mark Paid.
    await fulfillPaidInvoice(inv, newStatus, c);
